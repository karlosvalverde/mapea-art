    ...
    return (
        <>
            ...
            <div className="text-secondary text-break">
                ...
                <div><span className="bg-secondary p-1 px-2 text-dark mb-3">contato</span><br/>
                ...
                <div><span className="bg-secondary p-1 px-2 text-dark mb-3">vínculo institucional</span><br/>
