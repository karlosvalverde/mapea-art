            ...
            <div className="row pt-3">
                <div className="col col-lg-9">
                    {/* <form onSubmit={this.handleSubmit}> */}
                        ...
                        {/* Filter by State */}
                        <select name="state" value={this.state.state} onChange={this.handleChange} className="form-select bg-primary border border-dark  mb-3 shadow" aria-label="Filter by State">
                        ...
                        <select name="university" value={this.state.university} onChange={this.handleChange} className="form-select bg-primary border border-dark  mb-3 shadow" aria-label="Filter by University">
                        ...
                        {/* Filter by Role */}
                        <select name="role" value={this.state.role} onChange={this.handleChange} className="form-select bg-primary border border-dark  mb-3 shadow" aria-label="Filter by Role">
                        ...
                        <select name="research_field" value={this.state.research_field} onChange={this.handleChange} className="form-select bg-primary border border-dark  mb-3 shadow" aria-label="Filter by Research Field">
